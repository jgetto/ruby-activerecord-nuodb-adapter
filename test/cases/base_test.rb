...
class BasicsTest < ActiveRecord::TestCase
  ...
  unless current_adapter?(:PostgreSQLAdapter,:OracleAdapter,:SQLServerAdapter, :NuoDBAdapter)
  ...
  unless current_adapter?(:MysqlAdapter) || current_adapter?(:Mysql2Adapter) || current_adapter?(:NuoDBAdapter)
